...
TELEGRAM_BOT_TOKEN = '8445150248:AAEZRwB5qNBLdCLQ20xc8KRBk0dYDDQ-xgk'
...
def run_schedule():
    ...
    schedule.every(2).hours.do(job_check_budget_alerts)
    schedule.every(4).hours.do(job_mini_summary)
